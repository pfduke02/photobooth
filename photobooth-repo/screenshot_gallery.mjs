...
const seedThemes=['classic','warm','wedding'];
for(let i=0;i<3;i++){
  await page.evaluate((t)=>window.__PB.setTheme(t), seedThemes[i]);
...
await gp.goto('http://localhost:8099/gallery.html?local=1',{waitUntil:'load'});
